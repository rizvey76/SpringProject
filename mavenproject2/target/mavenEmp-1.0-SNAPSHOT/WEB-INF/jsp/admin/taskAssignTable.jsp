        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="container my-4">
                     <a href="/assignTaskPage" class="btn btn-success">+ Create New Project</a>
                </div>
...
<!--                    <p class="font-weight-bold">Task Table</p>-->
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-4 mb-xl-0">
                            ...
                            <div><h3 style="color: #002752">Projects Table:</h3></div>
                            <hr/>
                            
                   <table class="table dataTable table-md  w-auto small my-0 table-bordered " id="dataTable">
                                <thead class="thead-dark">
                                    <tr>
                                        <th scope="col">Project Code</th>
                                                                ...
                                                                <th scope="col">Status From Employee</th>
                                                                
                                                                <th scope="col">Message To Employee</th>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${map.allTaskData}" var="taskData">

                                        <tr>
                                                      
                                                                    <td>${taskData.taskId}</td>
                                                                     <td>${taskData.taskName}</td>
                                                                      <td>${taskData.assignDate}</td>
                                                                     
                                                                    <td>${taskData.startDate}</td>
                                                                    
                                                                      <td>${taskData.estmDate}</td>
                                                                    <td>${taskData.status}</td>
                                                                     <td>${taskData.empId}</td>
                                                                  
                                                                     <td>${taskData.empName}</td>
                                                                    

                                                                    <td>${taskData.taskStatus}</td>
                                                                   
                                                                    <td>
                                                                           <a href="/feedBackPage/${taskData.id}">Feedback</a>
                                                                    </td>
                                                                    
                                                                    
                                                                    
                                                                     <td>
                                                                           <a href="/deleteT/${taskData.id}" class="btn btn-danger">Delete</a>
                                                                       </td>
