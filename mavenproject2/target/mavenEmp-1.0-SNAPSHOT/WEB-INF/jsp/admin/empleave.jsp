...
<!--        <br/>
        ...
        <li class="nav-item" role="presentation" style="margin:0 0 15px 0;">
            <form action="#" method="post">
                <input type="hidden" name="empId" value="${empIdp}${empIdv}"/>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><h5>${empName}</h5></span><img class="border rounded-circle img-profile" src="/resources/vendor/css/assets/img/avatars/emp.png"></a>
                                    <div
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">
                                             ...
                                             <input type="submit" class="form-control ou btn2" value="Apply Leave"/>
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link"  role="tab"  aria-controls="profile" aria-selected="false">
                                         ...
                                         <div>
                                        <form action="/showHistoryData" method="post">
                                            <input type="hidden" class="form-control ou btn2" placeholder="Requesting Days" name="empId" value="${empIdp}${empIdv}"/>
...
<!--                                Generating Area-->
 ...
 <form action="/saveleaveData" method="post">  
            
            <div class="row">
           <div class="col">
               <label><strong style="color: #080b56;font-size:20px">From Date</strong></label>
            ...
            <div class="col">
                <label style="color:#040c3f"><strong style="color: #080b56;font-size:20px">To Date</strong></label>
               <hr/>
...
<!--     hidden Field-->
     ...
     <input type="hidden" class="form-control" placeholder="Requesting Days" name="empId" value="${empIdp}"/>
...
<!-- <div class="col">
        ...
        <label><strong style="color: #080b56;font-size:20px">Leave Type:</strong></label>
        <hr/>
        ...
        <label for="comment"><strong style="color: #0c68ac;font-size:20px">Leave Reason In Detail:</strong></label>
...
<!--         <button type="button" class="btn btn-success btn-lg btn-block">Submit</button>-->
   <input type="submit"  class="btn btn-info btn-lg btn-block" value="Apply"/>
