...
<!--                    <p class="font-weight-bold">Basic examples</p>-->
  <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Project Management</h4></div>
                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" href="/showTaskTable" role="tab" aria-controls="home" aria-selected="false">Assign Project</a>
                                    </li>
<!--                                    <li class="nav-item waves-effect waves-light">
