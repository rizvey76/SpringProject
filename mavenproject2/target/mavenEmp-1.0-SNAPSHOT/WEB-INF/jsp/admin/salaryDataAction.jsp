                                        ...
                                        <section>
                                            ...
                                            <div>
                                                <div >
                                                    ...
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Monthly  Salary Table</h4></div>
                                                    <hr/>
                                                    
                                                    <div class="d-flex justify-content-sm-start"><h3>Month:</h3> &nbsp;<h3 style="color: #06f318">${currentMonth}</h3></div>
                                                    
                                                    
                                                    
<!--                                                    <a href="/postSalary" class="btn btn-success" >Send</a>-->
                                                    
                                                    <form action="/batchInsertToHistoryTable" method="post">
                                                        
                                                        <div class="d-flex justify-content-end"><input type="submit" class="btn btn-success" value="Click Here To Pay"/></div>
                                                        <br/>
                                                        <br/>
                                                        ...
                                                        <thead class="thead-dark">
                                                            <tr>
                                                                ...
                                                                <th scope="col">Decrement</th>
                                                                 ...
                                                                 <th scope="col" style="text-align: center">increment Percentage</th>
                                                                 <th scope="col" style="text-align: center">Decrement Percentage</th>
                                                                                          ...
                                                                                          <td>${salData.increment}</td>
                                                                                           <td>${salData.deduction}</td>
                                                                                            <td>${salData.netSalary}</td>
                                                                                             ...
                                                                                             <td style="text-align: center">${salData.increPercent}</td>
                                                                                              <td style="text-align: center">${salData.deducPercent}</td>
                                                                                               <td>${salData.month}</td>
                                                                                               <td>${salData.year}</td>
                                                                                             ...
                                                                                             <input type="hidden" name="empId[]" value="${salData.empId}"/>
                                                                                             <input type="hidden" name="empName[]" value="${salData.empName}"/>
                                                                                             <input type="hidden" name="empDep[]" value="${salData.empDep}"/>
                                                                                             <input type="hidden" name="empDeg[]" value="${salData.empDeg}"/>
                                                                                             <input type="hidden" name="bSalary[]" value="${salData.bSalary}"/>
                                                                                             <input type="hidden" name="increment[]" value="${salData.increment}"/>
                                                                                             <input type="hidden" name="deduction[]" value="${salData.deduction}"/>
                                                                                             
                                                                                             
                                                                                             <input type="hidden" name="netSalary[]" value="${salData.netSalary}"/>
                                                                                             <input type="hidden" name="increPercent[]" value="${salData.increPercent}"/>
                                                                                             <input type="hidden" name="deducPercent[]" value="${salData.deducPercent}"/>
                                                                                             <input type="hidden" name="month[]" value="${salData.month}"/>
                                                                                             <input type="hidden" name="year[]" value="${salData.year}"/>
