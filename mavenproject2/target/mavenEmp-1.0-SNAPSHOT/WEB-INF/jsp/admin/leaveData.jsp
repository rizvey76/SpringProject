        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container my-4">
                 ...
                 <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center"> Leave Management</h4></div>
                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" href="/showLeaveData" role="tab" aria-controls="home" aria-selected="false">Leave Request Table</a>
                                    </li>
<!--                                    <li class="nav-item waves-effect waves-light">
...
<!--                                       <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                <c:forEach items="${map.allLeaveData}" var="leaveData">
                                                                <tr>
                                                                    <td>${leaveData.empId}</td>
                                                                    <td>${leaveData.empName}</td>
                                                                     <td>${leaveData.empDep}</td>
                                                                    <td>${leaveData.empDeg}</td>
                                                                    
                                                                      <td>${leaveData.subDate}</td>
                                                                    <td>${leaveData.fromDate}</td>
                                                                     <td>${leaveData.toDate}</td>
                                                                    <td>${leaveData.reqDays}</td>
