...
<!--                    <p class="font-weight-bold">Basic examples</p>-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-4 mb-xl-0">
                            ...
                            <div class="d-flex justify-content-center"><h4 style="color: #002752">Projects Table</h4></div>
                            <hr/>
                   ...
                   <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${map.taskDatabyEmp}" var="taskDatabyEmp">

                                        <tr class="table-light">
                                                      
                                                                    <td>${taskDatabyEmp.taskId}</td>
                                                                     <td>${taskDatabyEmp.taskName}</td>
                                                                      <td>${taskDatabyEmp.assignDate}</td>
                                                                     
                                                                    <td>${taskDatabyEmp.startDate}</td>
                                                                    
                                                                      <td>${taskDatabyEmp.estmDate}</td>
                                                                      <td>${taskDatabyEmp.note}</td>
                                                                    
                                                                    <td>${taskDatabyEmp.status}</td>
                                                                    
                                                                    
                                                                    
                                                                   
                                                                    <td>
                                                                           <a href="/taskDetailPage/${taskDatabyEmp.id}">Details</a>
                                                                    </td>
                                                                    
                                                                    <td style="text-align: center">${taskDatabyEmp.empMessageDate}</td>
