...
<div class="register-photo">
        <div class="form-container">
            ...
            <form action="/myAdmin" method="post">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Login</button></div><a class="already" href="#">Click&nbsp; here to create an account</a>
                <br/>
                <div class="d-flex justify-content-center"><p style="color:#f30e06" >${map.status}</p></div>
