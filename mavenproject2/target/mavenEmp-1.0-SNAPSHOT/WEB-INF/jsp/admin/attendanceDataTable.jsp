...
<!--                    <p class="font-weight-bold">Attendance</p>-->
  ...
  <div class="row">
    <div class="col-xl-12 mb-4 mb-xl-0">
        <div class="row d-flex justify-content-end">
            <h3>Today:</h3> &nbsp; <h3 style="color: #36b9cc">${day}${day1}</h3> &nbsp;&nbsp;
            <br/>
          
                <h3>Date:</h3>&nbsp; <h3 style="color: #36b9cc">${submissionDate}${submissionDate1}</h3> 
...
<!--                     <a href="/deleteAttendanceData" class="btn btn-danger">clear Data</a>-->
                                    <br/>
                                     <br/>
                                      <br/>
...
<!--                    <p class="font-weight-bold">Basic examples</p>-->
            ...
            <form action="/insertToHistory" method="post"> 
                
               
                
                
                <div class="d-flex justify-content-between"> 
                    <a href="/showAttendanceData" class="btn btn-success">Click Here To Start</a>
                    <input type="submit"  class="btn btn-info" value="Enroll Today's Attendance"/></div>
                            
                   <br/>   
                   <br/> 
                   <div> <h2 style="color: #004085">Attendance Table:</h2></div> 
                   <hr/>
                   ...
                   <table class="table dataTable table-bordered " id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${map.attendanceData}" var="atData">

                                        <tr>
                                                                    <td>${atData.empId}</td>
                                                                    <td>${atData.empName}</td>
                                                                     <td>${atData.empDep}</td>
                                                                    <td>${atData.empDeg}</td>
                                                                    
                                                                      <td>${atData.submissionDate}</td>
                                                                     <td>${atData.submissionTime}</td>
                                                                     
                                                                  
                                                                     <td>${atData.ip}</td>
                                                                      <td>${atData.day}</td>
                                                                      
                                                                      <td>${atData.statusSend}</td>
                                                                      
                                                                      
                                                                      
                                                                      <input type="hidden" name="empId[]" value="${atData.empId}"/>
                                                                      <input type="hidden" name="empName[]" value="${atData.empName}"/>
                                                                      <input type="hidden" name="empDep[]" value="${atData.empDep}"/>
                                                                      <input type="hidden" name="empDeg[]" value="${atData.empDeg}"/>
                                                                      
                                                                      <input type="hidden" name="submissionDate[]" value="${atData.submissionDate}"/>
                                                                      <input type="hidden" name="submissionTime[]" value="${atData.submissionTime}"/>
                                                                      <input type="hidden" name="ip[]" value="${atData.ip}"/>
                                                                      <input type="hidden" name="day[]" value="${atData.day}"/>
                                                                      
                                                                       <input type="hidden" name="statusSend[]" value="${atData.statusSend}"/>
...
<!--                                                                    
                                                                     <td>
                                                                           <a href="/leaveD/${leaveData.id}">Details</a>
                                                                       </td>
                                           -->
