                                                ...
                                                <form action="/sendFeedback" method="post">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <h4 style="color: #002752">Employee Details:</h4>
                                                            <hr/>
                                                            
                                                            
                                                            <div class="row">
                                                                <p>Employee's ID:&nbsp;<p style="color: #002752"> ${task.empId}</p> </p>   
                                                            </div>
                                                            
                                                            
                                                            <br/>
                                                            <div class="row">
                                                            <p>Employee Name:&nbsp;<p style="color: #002752">  ${task.empName}</p></p>
                                                             </div>
                                                              <br/>
                                                            <div class="row">
                                                              <p>Employee Department:&nbsp;<p style="color: #002752">${task.empDep} </p> </p>
                                                              </div>
                                                              <br/>
                                                            <div class="row">
                                                              <p>Employee Designation:&nbsp;<p style="color: #002752">${task.empDeg}</p> </p>
                                                             </div>
                                                             <br/>
                                                             
                                                             <h4 style="color: #002752">Project Information:</h4>
                                                             <hr/>
                                                             
                                                             <div class="row">
                                                             <p>Project Code:&nbsp; <p style="color: #07426b">${task.taskId}</p> </p>
                                                              </div>
                                                             <br/>
                                                             <div class="row">
                                                             <p>Project Name:&nbsp;<p style="color: #07426b">${task.taskName}</p> </p>
                                                             </div>
                                                            ...
                                                            <input type="hidden" class="form-control" name="empId" value="${emp.empId}"/>
                                                            <input type="hidden" name="empName" value="${task.empName}"/>
                                                            <input type="hidden" name="empDep" value="${task.empDep}"/>
                                                            <input type="hidden" name="empDeg" value="${task.empDeg}"/>
                                                            
                                                          
                                                            
                                                            
                                                            
                                                            <input type="hidden" class="form-control" name="taskId" value="${task.taskId}"/>
                                                            
                                                           

                                                            <input type="hidden" class="form-control" name="taskName" value="${task.taskName}"/>
                                                            
                                                            <br/>
                                                            <label for="exampleFormControlTextarea1">Message:</label>
                                                            <textarea class="form-control"  rows="5" name="empMessageDate" value=""></textarea>
