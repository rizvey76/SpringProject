                                        ...
                                        <section>
                                            ...
                                            <div>
                                                <div >
                                                    ...
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Report For Leave Management</h4></div>
                                                    <hr/>
...
<!--                                                    <a href="/postSalary" class="btn btn-success" >Send</a>-->
                                                    ...
                                                    <form>
                                                       <div class="d-flex justify-content-end">
                                                        <button class="btn btn-outline-primary" type="submit" onclick="myFunction()" style="padding: 10px;">Print</button>  
                                                    ...
                                                    <table class="table">
                                                        <thead class="thead-dark">
                                                            <tr  class="table-info">
                                                                ...
                                                                <th scope="col">To Date</th>
                                                                 ...
                                                                 <th scope="col" style="text-align: center">Leave Reason</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <c:forEach items="${map.allLeaveData}" var="salData">
                                                                                         ...
                                                                                         <td>${salData.empId}</td>
                                                                                          <td>${salData.empName}</td>
                                                                                           <td>${salData.empDep}</td>
                                                                                            ...
                                                                                            <td>${salData.subDate}</td>
                                                                                          <td>${salData.fromDate}</td>
                                                                                           <td>${salData.toDate}</td>
                                                                                            <td style="text-align: center">${salData.reqDays}</td>
                                                                                            
                                                                                            
                                                                                            
                                                                                            
                                                                                             <td style="text-align: center">${salData.levType}</td>
                                                                                              <td style="text-align: center">${salData.levReason}</td>
                                                                                               <td>${salData.approvDays}</td>
                                                                                               <td>${salData.actionStatus}</td>
