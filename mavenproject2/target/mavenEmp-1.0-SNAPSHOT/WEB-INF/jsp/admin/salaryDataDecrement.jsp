...
<!----decrement----->
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <form action="/salDecrementUpdate" method="post">
                                                    ...
                                                    Basic Salary:<input type="text" class="form-control" name="bSalary" value="${sm.bSalary}"/>
                                                    <br/>
                                                    Loans(%):<input type="text" class="form-control" name="loans" value="" id="loans" placeholder="insert  percentage value "/>
                                                    <br/>
                                                    Insurance(%):<input type="text" class="form-control" name="insurance" value="" id="insure" placeholder="insert  percentage value "/>
                                                    <br/>
                                                    Miscellaneous Deduction(%):<input type="text" class="form-control" name="mDeduction" id="mDeduc" value="" placeholder="insert  percentage value "/>
                                                    <br/>
                                                     Month:
								      ...
								      <option value="September">September</option>
                                                    ...
                                                    <br/>
                                                    Year:<input type="text" class="form-control" name="year" value="${sm.year}"/>
                                                    <br/>
                                                   ...
                                                   <input type="submit" onclick="setDefaults();setDefaults1();setDefaults2()" class="btn btn-primary btn-lg btn-block" value="Update"/>  
...
<!--
                                                                                ...
                                                                                <input type="text" class="form-control" placeholder="Miscellaneous deduction" name="mDeduction">
                                                                                <br/>
...
<!--                                                                                        /////Test generated////-->
                                                    ...
                                                    <a href="/salDecreView"  class="btn btn-outline-success">Click here To See Employee Data</a>


                                                               <a href="/salAction"  class="btn btn-outline-primary" >View Result</a>
                                                            
                                                            </div>
                    
                                                                                        
<!--                                                                 <a href="/salDecreView">Click here To See Data</a>-->
                                                                  <br/>
...
<!--                                                                  <h1>Update Section</h1>
                                                    ...
                                                    Loans:<input type="text" name="loans" value=""/>
                                                    Insurance:<input type="text" name="insurance" value=""/>
                                                    Miscellaneous Deduction:<input type="text" name="mDeduction" value=""/>
...
<!--                                                                                              <td>${salData.month}</td>
                                                                                             ...
                                                                                             <td><a href="/selectSalDec/${salData.id}" >
...
function setDefaults(){
    if(document.getElementById("loans").value===""){
        document.getElementById("loans").value = "0.0";
       
    }
}

function setDefaults1(){
    if(document.getElementById("mDeduc").value===""){
       
        document.getElementById("mDeduc").value = "0.0";
    }
}
...
function setDefaults2(){
    if(document.getElementById("insure").value===""){
        ...
        document.getElementById("insure").value = "0.0";
    }
}
