                                        ...
                                        <section>
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Report For Employees Data Management</h4></div>
                                                    <hr/>
                                                    ...
                                                    <table class = "table table-striped table-bordered" id="datatable">
                                                        <thead class="thead-dark">
                                                            <tr  class="table-info">
                                                                ...
                                                                <th scope="col" style="text-align: center">NID</th>
                                                                                          ...
                                                                                          <td>${empData.empName}</td>
                                                                                           <td>${empData.empDep}</td>
                                                                                            <td>${empData.empDeg}</td>
                                                                                             ...
                                                                                             <td>${empData.empJdate}</td>
                                                                                            <td>${empData.bSalary}</td>
                                                                                         
                                                                                           <td>${empData.empEmail}</td>
                                                                                            <td>${empData.empPhn}</td>
                                                                                            
                                                                                             <td>${empData.empNid}</td>
                                                                                          <td>${empData.empAddress}</td>
                                                                                           <td>${empData.empBirth}</td>
                                                                                            <td>${empData.empGen}</td>
                                                                                            <td>${empData.empBgroup}</td>
