        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container my-4">
                    ...
                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Reports</h4></div>
                    
                    <br/>


<!--                    <p class="font-weight-bold">Data Management </p>-->
                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link"  href="/empReportHit" role="tab" aria-controls="home" aria-selected="false">Employee Report</a>
                                    </li>


                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link"  href="/salaryReportHit" role="tab" aria-controls="profile" aria-selected="false">Salary Report</a>
                                    </li>


                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link"  href="/projectReportHit" role="tab" aria-controls="profile" aria-selected="false">Project Report</a>
                                    </li><!--
                                    -->
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link"   href="/attendanceReportHit" role="tab" aria-controls="profile" aria-selected="false">Attendance Report</a>
                                    </li>


                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link"  href="/leaveReportHit" role="tab" aria-controls="profile" aria-selected="false">Leave Report</a>
                                    </li>
                                        ...
                                        <section>
                                            ...
                                            <div class="container-fluid">
                                                <div class="container mt-5">
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Create Employee</h4></div>
                                                    ...
                                                    <form action="/save" method="post">
                                                        <div class="form-row p-0 m-0">
                                                            ...
                                                            <div class="col-lg-6 col-xl-6 p-0 m-0 p-3">
                                                                ...
                                                                <div class="form-group"><input class="form-control" type="text" placeholder="Basic Salary" name="bSalary"></div>
                                                                
                                                                 <div class="form-group">
                                                                       <label>Date Of Birth:</label>
                                                                       <input class="form-control" type="date" placeholder="Date Of Birth" name="empbirth"></div>
...
<!--                                                            </div>
                                                            <div class="col-lg-6 col-xl-6 p-0 m-0 p-3">-->
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="date" placeholder="Joing Date" name="empjdate"></div>
                                                            ...
                                                            <div class="col p-0 m-0 p-3 d-flex justify-content-end"><button class="btn btn-primary btn-block" type="submit">Save Data</button></div> 
                                    ...
                                    <div class="tab-pane fade" id="update" role="tabpanel" aria-labelledby="profile-tab">
                                                ...
                                                <div class="container">
                                                         <table class="table dataTable my-0 table-bordered table-responsive-sm" id="dataTable">
                                <thead>
                                    <tr>
                                        <th> Employee Id</th>
                                        <th> Employee  Name</th>
