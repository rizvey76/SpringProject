...
<!--                    <p class="font-weight-bold">Basic examples</p>-->
                     ...
                     <div class="d-flex justify-content-end">  <a href="/showHistoryAttendanceData" class="btn btn-primary">Click Here to See History</a></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-4 mb-xl-0">
                            ...
                            <!-- Section: Table -->
                            <div> <h3 style="color: #002752">Attendance Record:</h3></div>
                        <hr/>
                   ...
                   <table class="table dataTable table-bordered " id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${map.attendanceHistoryData}" var="atData">
