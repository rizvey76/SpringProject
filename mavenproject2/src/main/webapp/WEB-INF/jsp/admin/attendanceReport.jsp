                                        ...
                                        <section>
                                            ...
                                            <div>
                                                <div >
                                                    ...
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Report For Attendance System</h4></div>
                                                    <hr/>
...
<!--                                                    <a href="/postSalary" class="btn btn-success" >Send</a>-->
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <c:forEach items="${map.attendanceHistoryData}" var="salData">
                                                                                         ...
                                                                                         <td>${salData.empId}</td>
                                                                                          <td>${salData.empName}</td>
                                                                                           <td>${salData.empDep}</td>
                                                                                            ...
                                                                                            <td>${salData.submissionDate}</td>
                                                                                          <td>${salData.submissionTime}</td>
                                                                                           <td>${salData.ip}</td>
                                                                                            <td>${salData.day}</td>
