        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container my-4">
                    ...
                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center"> Data Management</h4></div>
                    <br/>
                        ...
                        <div class="col-xl-12 mb-4 mb-xl-0">
                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab"  href="/empAction" role="tab" aria-controls="profile" aria-selected="false">Update Employees Data</a>
                                    </li>
...
<!--                                    <li class="nav-item waves-effect waves-light">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab"  href="/empVi" role="tab" aria-controls="profile" aria-selected="false">Employees Record</a>
                                    </li>
