...
<!--                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" href="/showAttendanceData" role="tab" aria-controls="home" aria-selected="false">Attendance Table</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        ...
                                        <section>
                                            <div class="container-fluid">
                                                <div class="container mt-5">
                                                    ...
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Create Session For Attendance</h4></div>
...
<!--                                    new table-->
                                     ...
                                     <form action="/batchInsertToAttendance" method="post"> 
                                         <div ><input type="submit" style="color:#196cd7" class="btn btn-light" value="Create New Session"/></div>
                                         <hr/>
                                         <br/>
                                       <table>
                                                        <thead>
...
<!--                                                                <th scope="col">Employee ID</th>
                                      ...
                                      <c:forEach items="${map.emps}" var="empData">

                                        <tr>
                                            <td> <input type="hidden"   name="id[]" value="${empData.id}"></td>
                                                                                     
                                            <td> <input type="hidden"   name="empId[]" value="${empData.empId}"></td>
                                            <td> <input type="hidden"  name="empName[]" value="${empData.empName}"></td>
                                            <td> <input type="hidden"   name="empDep[]" value="${empData.empDep}"></td>
                                            <td> <input type="hidden"  name="empDeg[]" value="${empData.empDeg}"></td>
                                            
                                            <td> <input type="hidden"  name="statusSend[]" value="Absent"></td>
