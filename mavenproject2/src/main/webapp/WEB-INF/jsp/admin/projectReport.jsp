                                        ...
                                        <section>
                                            ...
                                            <div>
                                                <div >
                                                    ...
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Report For Project Management</h4></div>
                                                    <hr/>
...
<!--                                                    <a href="/postSalary" class="btn btn-success" >Send</a>-->
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <c:forEach items="${map.allTaskData}" var="salData">
                                                                                         ...
                                                                                         <td>${salData.empId}</td>
                                                                                          <td>${salData.empName}</td>
                                                                                           <td>${salData.empDep}</td>
                                                                                            ...
                                                                                            <td>${salData.taskId}</td>
                                                                                          <td>${salData.taskName}</td>
                                                                                           <td>${salData.assignDate}</td>
                                                                                            <td>${salData.startDate}</td>
                                                                                            
                                                                                            
                                                                                            
                                                                                            
                                                                                             <td>${salData.estmDate}</td>
