                                            ...
                                            <div class="col">
                                                ...
                                                <form action="/saveTask" method="post">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <legend> <h4>Project Assign</h4></legend>
...
<!--                                                            <input type="hidden" class="form-control" name="id" value="${emp.id}"/>-->
                                                            ...
                                                            <input type="hidden" name="empDep" value="${emp.empDep}"/>
                                                            <input type="hidden" name="empDeg" value="${emp.empDeg}"/>
                                                            
                                                            <br/>
                                                            <label for="exampleFormControlTextarea1">Project Code:</label>
                                                            <input type="text" class="form-control" name="taskId" value=""/>
                                                            ...
                                                            <br/>
                                                            <label for="exampleFormControlTextarea1">Estimated End Date:</label>
                                                            <input type="date"  class="form-control" name="estmDate" value=""/>
...
<!--                                                            <div class="form-group">
                                            ...
                                            <div class="col">
                                                ...
                                                <fieldset class="border p-2">
                                                    <legend> <h4>Select Employee</h4></legend>
...
<!--                                                                            <th scope="col">Employee Name</th>-->
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <c:forEach items="${map.employees}" var="empData">
...
<!--                                                                                <td>${empData.empName}</td>-->
                                                                                ...
                                                                                <td>${empData.empDeg}</td>

                                                                                <td><a href="/selectToAssign/${empData.id}" >
