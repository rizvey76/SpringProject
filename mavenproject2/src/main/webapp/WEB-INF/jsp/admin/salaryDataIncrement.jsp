                ...
                <div class="container my-4">
                     ...
                     <div>
                                                ...
                                                <form action="/salUpdate" method="post">
                                                    ...
                                                    <fieldset class="border p-2">
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            Basic Salary:<input class="form-control"  type="text" name="bSalary" value="${sm.bSalary}"/>
                                                            <br/>
                                                            Bonus(%):<input type="text" class="form-control" id="bonus" name="bonus" placeholder="insert  percentage value "/>
                                                            <br/>
                                                            Special Pay(%):<input type="text" class="form-control" id="spPay" name="specialPay" placeholder="insert  percentage value "/>
                                                            <br/>
                                                            Month:
								      ...
								      <option value="September">September</option>
                                                            ...
                                                            <br/>
                                                            Year:<input type="text" class="form-control" name="year"/>
                                                            <br/>
                                                            ...
                                                            <input type="hidden" name="empDeg" value="${sm.empDeg}"/>
                                                             ...
                                                             <input type="submit" onclick="setDefaults();setDefaults1()" class="btn btn-primary btn-lg btn-block" value="Update"/>
...
<!--                                                            <div class="col">
                                                    ...
                                                    <a href="/salIncreView"  class="btn btn-outline-success">Click here To See Employee Data</a>
...
<!--                                                        <form action="/showIdData">
                                                            <input type="text" name="id" value="${sm.id}"/>
...
<!--                                                        <form action="/salUpdate" method="post">
                                                            ...
                                                            Bonus:<input type="text" name="bonus" value=""/>
...
function setDefaults(){
    if(document.getElementById("bonus").value===""){
        document.getElementById("bonus").value = "0.0";
       
    }
}

function setDefaults1(){
    if(document.getElementById("spPay").value===""){
       
        document.getElementById("spPay").value = "0.0";
    }
}
</script>
